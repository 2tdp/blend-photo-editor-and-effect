...
import com.remi.blendphoto.photoblender.photomixer.adapter.BucketAdapter
import com.remi.blendphoto.photoblender.photomixer.adapter.ChooseImageAdapter
import com.remi.blendphoto.photoblender.photomixer.addview.ViewPickPicture
...
import com.remi.blendphoto.photoblender.photomixer.data.DataPic
...
class PickPictureFragment(callBack: ICallBackItem, isFinish: ICallBackCheck) : Fragment() {
    ...
    lateinit var detailPictureAdapter: ChooseImageAdapter
        ...
        bucketAdapter = BucketAdapter(requireContext(), object : ICallBackItem {
            override fun callBack(ob: Any, position: Int) {
                ...
                detailPictureAdapter =
                    ChooseImageAdapter(requireContext(), object : ICallBackItem {
                        override fun callBack(ob: Any, position: Int) {
